package com.coimbra.pontoeletronico.api.dtos;
...
public class CadastroPFDto {
	...
	@NotEmpty(message = "Nome não pode ser vasio.")
	...
	@Length(min = 5, max = 200, message = "Email deve conter entre 5 e 200 cararcteres.")
