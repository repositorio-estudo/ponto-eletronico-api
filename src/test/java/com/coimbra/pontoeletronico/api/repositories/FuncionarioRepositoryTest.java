...
public class FuncionarioRepositoryTest {
	...
	@Test
	public void testBuscarFuncionarioPorEmailError() {
		Funcionario funcionario = this.funcionarioRepository.findByEmail("invalido@email.com");
	...
	public void testBuscarFuncionarioPorCpfOuEmailParaEmailInvalido() {
		Funcionario funcionario = this.funcionarioRepository.findByCpfOrEmail(CPF, "invalido@email.com");
