...
public class EmpresaControllerTest {
	...
	private static String BUSCAR_EMPRESA_CNPJ_URL = "/api/empresaa/cnpj/";
	private static Long ID = Long.valueOf(1);
	private static String CNPJ = "51463645000100";
	private static String RAZAO_SOCIAL = "Empresa XYZ";
...
//				.andExpect(jsonPath("$.errors").value("Empresa não encontrada para o CNPJ "+ CNPJ));
	...
	@Test
	public void testeBuncarEmpresaCnpjValido() throws Exception{
