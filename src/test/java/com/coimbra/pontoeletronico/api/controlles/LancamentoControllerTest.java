package com.coimbra.pontoeletronico.api.controlles;
...
import com.coimbra.pontoeletronico.api.dtos.LancamentoDto;
...
import com.coimbra.pontoeletronico.api.services.LancamentoService;
...
public class LancamentoControllerTest {
	...
	private static final String URL_BASE = "/api/lacamento/";
...
//				.andExpect((ResultMatcher) jsonPath("$.data.id").value(ID_LANCAMENTO))
//				.andExpect((ResultMatcher) jsonPath("$.data.tipo").value(TIPO))
//				.andExpect((ResultMatcher) jsonPath("$.data.data").value(DATA))
//				.andExpect((ResultMatcher) jsonPath("$.data.funcionarioId").value(ID_FUNCIONARIO))
//				.andExpect((ResultMatcher) jsonPath("$.errors").isEmpty()));
	}
...
//				.andExpect((ResultMatcher) jsonPath("$.errors").value("Funcionário não encontrado. ID inexistente"))
